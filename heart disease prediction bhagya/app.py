...
LOG_MODEL_PATH = "model/model_heart.pkl"
...
def main():
    ...
    st.subheader("Are you worried about the condition of your heart? "
    ...
    with col1:
        st.image("images/doctor.png",
                 caption="I'll help you diagnose your heart health!",
                 width=150)
    ...
    if submit:
        ...
        if prediction == 0:
            st.markdown(f"**The probability that you'll have"
                        ...
                        f" You are healthy!**")
            st.image("images/vec.jpg",
                     caption="Your heart seems to be okay! ")
        else:
            st.markdown(f"**The probability that you will have"
                        f" heart disease is {round(prediction_prob[0][1] * 100, 2)}%."
                        f" It sounds like you are not healthy.**")
            st.image("images/heart-bad.jpg",
                     caption="I'm not satisfied with the condition of your heart!")
